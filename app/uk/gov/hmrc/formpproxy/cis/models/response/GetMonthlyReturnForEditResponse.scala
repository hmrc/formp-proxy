...
case class GetMonthlyReturnForEditResponse(
...
object GetMonthlyReturnForEditResponse:
  given format: OFormat[GetMonthlyReturnForEditResponse] = Json.format[GetMonthlyReturnForEditResponse]
