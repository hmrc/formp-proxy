...
import uk.gov.hmrc.formpproxy.actions.{ApiKeyAction, AuthAction, AuthOrApiKeyAction, CisAuthOrApiKeyAction, DefaultApiKeyAction, DefaultAuthAction, DefaultAuthOrApiKeyAction, DefaultCisAuthOrApiKeyAction}
...
class Module extends AppModule:
  ...
  override def bindings(
    ...
    List(
      ...
      bind[ApiKeyAction].to(classOf[DefaultApiKeyAction]),
      bind[AuthOrApiKeyAction].to(classOf[DefaultAuthOrApiKeyAction]),
      bind[CisAuthOrApiKeyAction].to(classOf[DefaultCisAuthOrApiKeyAction]),
