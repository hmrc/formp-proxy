...
import uk.gov.hmrc.formpproxy.actions.{AuthAction, DefaultAuthAction, DefaultInternalAuthAction, InternalAuthAction}
...
class Module extends AppModule:
  ...
  override def bindings(
    ...
    List(
      ...
      bind[InternalAuthAction].to(classOf[DefaultInternalAuthAction]),
