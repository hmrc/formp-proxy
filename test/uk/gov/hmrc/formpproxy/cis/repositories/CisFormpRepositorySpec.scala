...
final class CisFormpRepositorySpec extends SpecBase {
  ...
  "updateSubcontractor" - {
    ...
    "preserves existing subcontractor fields when fields are missing from the update payload" in {
      ...
      val result =
        repo.updateSubcontractor(request).futureValue
      ...
      verify(csUpdateSub).setString(7, "Gary")
      ...
      verify(csUpdateSub).setString(13, "1 Old Street")
      ...
      verify(csUpdateSub).setString(19, "old@test.com")
      verify(csUpdateSub).setString(20, "01234567890")
