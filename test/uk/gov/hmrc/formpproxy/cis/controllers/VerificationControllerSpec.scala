...
class VerificationControllerSpec extends SpecBase {
  ...
  "POST /cis/verification/submission-batch (getSubmissionWithVerificationBatch)" - {

    val url = "/cis/verification/submission-batch"
  ...
  "POST /cis/verification/proceed-verification (proceedVerification)" - {

    val url = "/cis/verification/proceed"
